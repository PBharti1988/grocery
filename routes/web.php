...
Route::get('/', 'DashBoardController@liststores');
Route::post('/', 'DashBoardController@redirect_to_store');
...
Route::get('/proceed-to-pay', 'FreechargeController@index');
Route::any('/payment-failed', 'FreechargeController@failed');
Route::any('/payment-successful', 'FreechargeController@successful');
...
// ...............Slider Route.......................................................
    ...
    Route::resource('/slider', 'SliderOptionController');

    Route::post('/update/{id}', ['as'=>'sliderupdate','uses'=>'SliderOptionController@update']);



    Route::get('/slideroption/{id}', 'SliderSubOptionController@index');

    Route::get('/slideroptioncreate/{id}', 'SliderSubOptionController@create');

    Route::post('/store', ['as'=>'slideroptionsstore','uses'=>'SliderSubOptionController@store']);
    Route::get('sliderupdate/{id}', ['as'=>'slideroptionupdate','uses'=>'SliderSubOptionController@edit']);
