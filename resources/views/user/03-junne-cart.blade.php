      ...
      <div class="container">
        <div class="row bg-white rounded shadow-sm">
          ...
          <!-- <div class="row py-5 p-4 bg-white rounded shadow-sm"> -->
            ...
            <?php 
			if(isset($detailsCookie) && isset($detailsCookie['details']))
			{

			if($detailsCookie['details']['table_id']=='0')
				{
	//				print_r($cartCookie);
			?>
	              ...
	              <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Delivery Option</div>
	              	<div class="p-4">
						<div class="custom-control custom-radio">
						  <input type="radio" class="custom-control-input" id="takeaway" name="delivery_option"  value="takeaway">
					...
					<div class="p-4">
						<div class="custom-control custom-radio">
						  <input type="radio" class="custom-control-input" id="homedelivery" name="delivery_option"  value="homedelivery">
            ...
            <div class="col-lg-6">
              ...
              <div class="p-4">
                <div class="input-group ">
                  ...
                  <input id="fullname" type="text" placeholder="Full Name" class="form-control border-0" <?php if(isset($detailsCookie['details']['fullname'])) echo 'value="'.$detailsCookie['details']['fullname'].'"'; ?>   />
                </div>
	...
	//				print_r($cartCookie);
			...
			<?php		
				...
				?>
      			...
      			<input type="hidden" id="address" class="form-control" name="address" value="Dine In" />
...
<!--               <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Instructions for seller</div>
            ...
            <div class="col-lg-6">
              ...
              <div class="p-4">
                ...
                </ul><button class="btn btn-dark rounded-pill py-2 btn-block"  onclick="javascript:validate_pd();">Place Order</button>
              </div>
            </div>
          <!-- </div> -->
        </div>
...
?>
  ...
  if(cartdetails['details']['mobile'])
  {
    ...
    var cartdetails = JSON.parse(cm_readCookie('qcart1'));
    cartdetails['details']['fullname']= $('#fullname').val();
    cartdetails['details']['delivery_address']= $('#address').val();
...
?>
<?php //print_r($_COOKIE); ?>
<?php // $cartCookie=json_decode($_COOKIE[$url],true); print_r($cartCookie['8']); ?>
