            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 bg-white rounded shadow-sm">
                      <div class="od-center">
                        <div class="thanks-heading"><h2>Thank you!</h2></div>
                        <div class="thanks-sub-line"><h4>We are happy to tell you that your order is completed successfully.</h4></div>
                        <div class="orderdet"><ul>
                          <li><span>Payment ID#</span>:<span class="orderid">{{$data->payment_id}}</span></li>  
                            <li><span>Bill No#</span>:<span class="orderid">{{$data->bill_number}}</span></li>          
      ...
      <div class="modal-content">
        ...
        <!---feedback-->
          ...
          <form id="feedback" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <label for="recipient-name" class="control-label">Name:</label>
              <input type="text" name="name" id="name" required class="form-control" id="" <?php if(isset($detailsCookie['details']['fullname'])) echo 'value="'.$detailsCookie['details']['fullname'].'"'; ?>>
            </div>
            <div class="form-group">
              <label for="recipient-name" class="control-label">Email:</label>
            ...
            <div class="form-group">
              <label for="recipient-name" class="control-label">Mobile:</label>
              <input type="text" name="mobile" id="mobile" class="form-control" id="recipient_mobile" <?php if(isset($detailsCookie['details']['mobile'])) echo 'value="'.$detailsCookie['details']['mobile'].'"'; ?>>
            </div>
