        ...
        @include('admin.admin-layouts.flash-message')
            <div class="card card-body">
                ...
                <div class="row">
                    <div class="col-sm-10 col-xs-12">
                        ...
                        <div class="form-group">
                               ...
                               <select class="form-control" name="question_type" id="question_type" required>
                                  ...
                                  @foreach($type as $val)
                                  <option value="{{$val->id}}" @if($question->question_type_id == $val->id) selected @endif>{{$val->type}}</option>
                                  @endforeach
                               </select>
                            </div>
                            <input type="hidden" name="type" value="{{$question->question_type_id}}" />
                            <div class="form-group">
                    ...
                    <input type="hidden" value="{{$val->id}}" name="option_id[]" >
                                <div class="form-group sl">
                                    <input type="text" style="width:87%;" value="{{$val->options}}" id="to_amount1"
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" name="enabled" class="custom-control-input"
                                        id="customSwitch1" {{$question->enabled == 1 ? 'checked': ''}}>
                            ...
                            <button type="submit"
                                ...
                                <a class="btn btn-secondary width-sm waves-effect waves-light" href="{{url('/question')}}">Back</a>
                        </form>
                    </div>
                </div>
            </div>
