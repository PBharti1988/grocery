        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit City Area</li>
                </ol>
    ...
    <div class="row">
        ...
        @include('admin.admin-layouts.flash-message')
            <div class="card card-body">
                <h3 class="box-title m-b-0">Edit City Area</h3>
                <br>
                <div class="row">
                    <div class="col-sm-10 col-xs-12">
                        <form method="post" action="{{route('storelocation.update',$area->id)}}" enctype="multipart/form-data">
                        {{ method_field('put') }}
                        {{csrf_field()}}
                             ...
                             <div class="form-group">
                                ...
                                <input type="text" id="city_name" name="city_name" value="{{$area->city_name}}" readonly="readonly" class="form-control"
                            ...
                            <button type="submit"
                                ...
                                <a class="btn btn-secondary width-sm waves-effect waves-light" href="{{url('/storelocation')}}">Back</a>
                        </form>
                    </div>
                </div>
            </div>
