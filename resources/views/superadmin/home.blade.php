...
// echo 'hellooooooooooooooooooooo'. URL::to('/');

// $qrcode=QR::size(500)->errorCorrection('H')->margin(1000)->format('png')->generate(URL::to('/').'/fb15f00d');
//echo $qrcode;

//        $qrrr=\App\Qrcode::where('id',1)->first();
//print_r($qrrr);

/*        \QR::size(500)->errorCorrection('H')->margin(100)
        ->format('png')
        ->generate('http://testsite.com/restaurant/fb15f00d', public_path('qr-images/test.png')); 
*/

// <img height="100px" src="data:image/png;base64,{!! base64_encode($qrcode) !!} ">

// <img class="qrImage" src="data:image/png;base64, {!! base64_encode(QR::format('png')->size(200)->generate('http://testsite.com/restaurant/fb15f00d')) !!}"/>
 ?>
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            ...
                                            <p class="text-muted">Dieticians</p>
                                        </div>
                                        <div class="ml-auto">
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex no-block align-items-center">
                                        <div>
                                            ...
                                            <p class="text-muted">GYM Members</p>
                                        </div>
                                        <div class="ml-auto">
...
<script src="{!!URL::to('/') . '/public/js/add-download-btn.js' !!}"></script>
 <script>
    ...
    $(".qrImage").addDownloadBtn(text, className);
</script>
-->
@endsection